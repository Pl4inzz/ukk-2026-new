...
@section('content')
    ...
    <!-- Banner Header -->
    <div class="card border-0 shadow-sm mb-4" style="background-color: #2b3035; border: 2px solid #495057 !important; border-radius: 12px;">
        <div class="card-body p-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
                <span class="badge rounded-pill px-3 py-2 mb-2" style="background-color: #3d2a10; color: #f39c12; border: 1px solid #7c4c0b; font-size: 11px;">
                    Panel Administrator
                </span>
                <h1 class="h4 mb-1 fw-bold text-white">Selamat Datang, {{ $user->username }}! 👋</h1>
                <p class="text-secondary mb-0 small">Kelola data master area parkir, pengguna, serta keanggotaan sistem dari satu tempat.</p>
            </div>
            <div>
            </div>
        </div>
    ...
    <!-- SECTION 1: Pengguna & Akses (2 Box Simetris) -->
    <div class="mb-4">
        <h2 class="h6 text-secondary text-uppercase fw-semibold mb-3 style-tiny" style="letter-spacing: 0.5px;">Pengguna & Keanggotaan</h2>
        <div class="row g-4">
            <!-- Box Total Pengguna -->
            <div class="col-md-6">
                <a href="{{ route('admin.users.index') }}" class="card border-0 shadow-sm text-decoration-none h-100 hover-card overflow-hidden" style="background-color: #2b3035; border: 2px solid #495057 !important; border-radius: 10px;">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between text-secondary small">
                            ...
                            <span class="fw-semibold d-inline-flex align-items-center gap-1 ms-2" style="color: #f39c12;">
                                Lihat 
            ...
            <!-- Box Total Roles -->
            <div class="col-md-6">
                <a href="{{ route('admin.roles.index') }}" class="card border-0 shadow-sm text-decoration-none h-100 hover-card overflow-hidden" style="background-color: #2b3035; border: 2px solid #495057 !important; border-radius: 10px;">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start justify-content-between gap-3 mb-3">
                            <div class="d-flex align-items-center gap-3">
                                <div class="p-3 rounded-3 d-flex align-items-center justify-content-center" style="background-color: #3d2a10; color: #f39c12; border: 1px solid #7c4c0b; width: 52px; height: 52px;">
    ...
    <!-- SECTION 2: Fitur Utama Parkir (2 Box Berdampingan) -->
    <div>
        <h2 class="h6 text-secondary text-uppercase fw-semibold mb-3 style-tiny" style="letter-spacing: 0.5px;">Fitur Utama Parkir</h2>
        <div class="row g-4">
            <!-- Box Area Parkir -->
            <div class="col-md-6">
                <a href="{{ route('area-parkir.index') }}" class="card border-0 shadow-sm text-decoration-none h-100 hover-card overflow-hidden" style="background-color: #2b3035; border: 2px solid #495057 !important; border-radius: 10px;">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start justify-content-between gap-3 mb-3">
                            <div class="d-flex align-items-center gap-3">
                                <div class="p-3 rounded-3 d-flex align-items-center justify-content-center" style="background-color: #3d2a10; color: #f39c12; border: 1px solid #7c4c0b; width: 52px; height: 52px;">
            ...
            <!-- Box Total Member (Dipindahkan ke Fitur Utama Parkir) -->
            <div class="col-md-6">
                <a href="{{ route('member.index') }}" class="card border-0 shadow-sm text-decoration-none h-100 hover-card overflow-hidden" style="background-color: #2b3035; border: 2px solid #495057 !important; border-radius: 10px;">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start justify-content-between gap-3 mb-3">
                            <div class="d-flex align-items-center gap-3">
                                <div class="p-3 rounded-3 d-flex align-items-center justify-content-center" style="background-color: #3d2a10; color: #f39c12; border: 1px solid #7c4c0b; width: 52px; height: 52px;">
                        ...
                        <div class="d-flex align-items-center justify-content-between text-secondary small">
                            <span>Kelola data keanggotaan & tarif khusus.</span>
                            <span class="fw-semibold d-inline-flex align-items-center gap-1 ms-2" style="color: #f39c12;">
                                Lihat 
                                <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7"></path></svg>
                            </span>
